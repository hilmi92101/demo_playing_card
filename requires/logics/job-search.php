...
$original_sql = "SELECT Jobs.id AS `Jobs__id`,
...
LEFT JOIN jobspersonalities JobsPersonalities
...
LEFT JOIN jobscareerpaths JobsCareerPaths
...
LEFT JOIN jobsrecqualifications JobsRecQualifications
...
LEFT JOIN jobsreqqualifications JobsReqQualifications
...
$improved_sql_1 = "SELECT Jobs.id AS `Jobs__id`,
Jobs.name AS `Jobs__name`,
Jobs.media_id AS `Jobs__media_id`,
Jobs.job_category_id AS `Jobs__job_category_id`,
Jobs.job_type_id AS `Jobs__job_type_id`,
...
/*
$sql = "SELECT 
Jobs.id AS `Jobs__id`, Jobs.name AS `Jobs__name`,
Jobs.media_id AS `Jobs__media_id`,
Jobs.job_category_id AS `Jobs__job_category_id`,
Jobs.job_type_id AS `Jobs__job_type_id`,
Jobs.description AS `Jobs__description`,
